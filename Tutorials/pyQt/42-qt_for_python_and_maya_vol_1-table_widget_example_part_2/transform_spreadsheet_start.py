...
class TableExampleDialog(QtWidgets.QDialog):
    ...
    def refresh_table(self):
        ...
        for i in range(len(meshes)):
            ...
            self.insert_item(
                i, 2, self.float_to_string(translation[0]), "tx", translation[0], False
            )
            self.insert_item(
                i, 3, self.float_to_string(translation[1]), "ty", translation[1], False
            )
            self.insert_item(
                i, 4, self.float_to_string(translation[2]), "tz", translation[2], False
            )
    ...
    def on_cell_changed(self, row, column):
        ...
        if column == 1:
            ...
            self.update_attr(full_attr_name, item, is_boolean)
    ...
    def update_attr(self, full_attr_name, item, is_boolean):
        if is_boolean:
    ...
    def get_full_attr_name(self, row, column):
        ...
        attr_name = self.get_item_attr(self.table_wdg.item(row, column))
